...
from colloquip.models import EngineConfig
...
class EnergyConfig(BaseModel):
    ...
    injection: Dict[str, float] = Field(
        default_factory=lambda: {
            "new_knowledge": 0.3,
...
class TriggerConfig(BaseModel):
    ...
    relevance_phase_modulation: Dict[str, int] = Field(
        default_factory=lambda: {
            "explore": 1,
            "debate": 2,
            "deepen": 3,
    ...
    silence_max: int = 6
    silence_phase_modulation: Dict[str, int] = Field(
        default_factory=lambda: {
            "explore": 4,
            "debate": 6,
            "deepen": 8,
